...
<body>
        ...
        <div class="header1">
           ...
           <nav class="header2">
               ...
               <ul>
                   ...
                   <li><a href="homeHandball.php" style="color: #045D8C;">HANDBALL</a></li>
    ...
    <div class="contenido">
        ...
        <a href="ligaHandballTabla.php" style="text-decoration:none; color:black">
            <div class="figura2">
                <p>Tabla de posiciones</p>
            </div>
        </a>
        <a href="ligaHandballEstadisticas.php" style="text-decoration:none; color:black"> 
            <div class="figura3">
                <p>Estadísticas</p>
            </div>
        </a>
        ...
        <table>
            <tr> 
                ...
                <th><div class="e-item"><p>PE</p></div></th>
                <th><div class="e-item"><p>PP</p></div></th>
                <th><div class="e-item"><p>GF</p></div></th>
                <th><div class="e-item"><p>GC</p></div></th>
            ...
            <tr>
                ...
                <td><div class="item"><p>0</p></div></td>
                <td><div class="item"><p>0</p></div></td>
        ...
        <p class="pieTabla">PJ - partidos jugados | PG - partidos ganados | PE - partidos empatados | PP - partidos perdidos | GF - goles a favor<br>
         GC - goles en contra | DIF - diferencia de goles | ULT. P - resultados ultimos 5 partidos </p>
        </div>
