...
<body>
    ...
    <div class="formulario">
        <form action="" method="post">
            ...
            <input class="nombre" type="text" id="nombre" name="nombre" minlength="2" required onkeypress="return (event.charCode == 209 || event.charCode == 241 || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">

            <div class="figura3">
                <p>APELLIDO</p>
            </div>

            <input class="apellido" type="text" id="apellido" name="apellido" required minlength="2" onkeypress="return (event.charCode == 209 || event.charCode == 241 || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">

            <div class="figura3">
                <p>CI</p>
            </div>

            <input class="ci" type="number" id="ci" name="ci" min="999999" max="99999999" required placeholder="Ingresa la ci sin el '-'">

            <div class="figura3">
                <p>FECHA DE NACIMIENTO</p>
            </div>

            <input class="fechaNac" type="date" id="fechaNac" name="fechaNac" minlength="8" required>

            <div class="figura3">
                <p>ALTURA</p>
            </div>
            
            <input class="altura" type="number" id="altura" required min="90" max="230" name="altura" placeholder="ej: 190">
            ...
            <input class="equipo" type="text" id="equipo" name="equipo" maxlength="30" required>

            <div class="figura3">
                <p>POSICIÓN</p>
            </div>

            <div class="radioButton"><input type="radio" name="posicion" id="golero"><p>GOLERO</p></div>
            ...
            <button type="submit" onclick="show()" style="margin-top: 0;">ACEPTAR</button>
        </form>
    </div>
    </a>
    </div>
