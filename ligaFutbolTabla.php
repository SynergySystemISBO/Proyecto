...
<body>
        ...
        <div class="header1">
           ...
           <nav class="header2">
               ...
               <ul>
                   ...
                   <li><a href="homeFutbol.php" style="color: #045D8C;">FÚTBOL</a> </li>
    ...
    <div class="contenido">
        ...
        <a href="ligaFutbolTabla.php" style="text-decoration:none; color:black">
            <div class="figura2">
                <p>Tabla de posiciones</p>
            </div>
        </a>
        <a href="ligaFutbolEstadisticas.php" style="text-decoration:none; color:black"> 
            <div class="figura3">
                <p>Estadísticas</p>
            </div>
        </a>
