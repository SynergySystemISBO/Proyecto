...
;">
    <a href="#goleadores" style="text-decoration: none; color:black; margin-right: 5px;">
        <div class="goleadores" style="margin-top: 10px;">
            <p style="font-weight: 600;">TABLA DE GOLEADORES</p>
        </div>
    </a>
    <a href="#asistidores" style="text-decoration: none; color:black">
    <div class="asistidores">
        <p style="font-weight: 600;">TABLA MAS PARTIDOS JUGADOS</p>
    </div>
    </a>
</div>
        ...
        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            <ul class="slider">
                ...
                <tr> 
                    ...
                    <th><div class="e-item"><p>GOLES</p></div></th>
                </tr>
                ...
                <li id="asistidores">
                    ...
                    <tr> 
                        <th><div class="equipos"><p>JUGADOR</p></div></th>
                        <th><div class="e-item2"><p>PARTIDOS</p></div></th>
                    </tr>
