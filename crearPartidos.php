...
<body>
    ...
    <div class="formulario">
        <form action="" method="post">
            ...
            <option value="" selected disabled></option>
            <option value="arbitroA">ARBITRO 1</option>
            ...
            <select name="arbitro2" id="arbitro2">
                <option value="" selected disabled></option>
                <option value="arbitroA">ARBITRO 4</option>
            ...
            <select name="arbitro3" id="arbitro3">
                <option value="" selected disabled></option>
                <option value="arbitroA">ARBITRO 7</option>
            ...
            <button onclick="show()" type="submit">CREAR</button>
        </form>
        <script>
            function show(){
